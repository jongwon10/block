...
var Game = /** @class */ (function () {
    function Game() {
        ...
        this.noticePopup = document.getElementById('nPopup');
        this.noticePopup.style.display = 'none';
        
        document.addEventListener('keydown', function (e) {
            if (_this.state === _this.STATES.STARTED && e.keyCode == 32)
                _this.onAction();
        });
        
        document.addEventListener('click', function (e) {
            if (_this.state === _this.STATES.STARTED)
                _this.onAction();
        });
        ...
        var noticeStatBtn = document.getElementById('sBtn');
        if (noticeStatBtn) {
            noticeStatBtn.addEventListener('click', function () {
                // _this.sBtnClikcked = true;
    ...
    Game.prototype.placeBlock = function () {
        ...
        if (newBlocks.chopped) {
            ...
            TweenLite.to(newBlocks.chopped.rotation, 1, positionParams);
        }
        this.addBlock();
    };
